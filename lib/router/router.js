...
import { _rewriteUrlForNextExport, removeBasePath } from './'
...
export default class Router {
  ...
  constructor (pathname, query, as, { initialProps, pageLoader, App, Component, ErrorComponent, err, basePath } = {}) {
    ...
    if (Component !== ErrorComponent) {
      this.components[this.route] = { Component, props: initialProps, err, basePath }
    }
  ...
  async fetchComponent (route, as) {
    route = removeBasePath(route, this.basePath)
    let cancelled = false
